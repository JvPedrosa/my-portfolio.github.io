...
const en: Dictionary = {
  ...
  contact: {
    ...
    formDescription:
      "If you prefer, send a message here. Direct contact by email, LinkedIn, and GitHub is still available alongside the form.",
    ...
    sendError:
      "I couldn't send your message right now. Please try again or use the direct contact options.",
    invalidName: "Please enter your name before sending.",
    invalidEmail: "Please enter a valid email address.",
    invalidMessage: "Please write a more complete message before sending.",
